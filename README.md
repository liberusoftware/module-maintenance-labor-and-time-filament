...
> This optional Filament 5 presentation package presents exactly one independent domain module. It contributes reusable resources, pages, widgets, schemas, tables, infolists, and actions to application-owned panels while delegating authorization, validation, tenancy, persistence, and business rules to the maintenance-labor-and-time public boundary.
...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-maintenance-labor-and-time-filament?sort=semver)](https://github.com/liberusoftware/module-maintenance-labor-and-time-filament/releases/latest) [![Tests](https://github.com/liberusoftware/module-maintenance-labor-and-time-filament/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-maintenance-labor-and-time-filament/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-maintenance-labor-and-time-filament
```
...
<a href="https://github.com/liberusoftware/module-maintenance-labor-and-time-filament/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-maintenance-labor-and-time-filament" alt="Contributors to liberusoftware/module-maintenance-labor-and-time-filament">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-maintenance-labor-and-time-filament/graphs/contributors).
